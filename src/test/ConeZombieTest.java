 ...
 * methods in the abstract class ConeZombie
 * @author Arzaan Irani
 * 100826631
...
public class ConeZombieTest {
	...
	public void setUp() throws Exception {
		...
		testZombie1 = new ConeZombie();
	}
	
	@Test
	public void defaultConstructor(){
		assertTrue("Max HP should be set to default", testZombie1.getMaxHP() == ConeZombie.MAX_HP);
	}

	@Test
	public void getType(){
		assertTrue("ConeZombie type should be CONE", testZombie1.getType() == Zombie.Type.CONE);
	}
}
